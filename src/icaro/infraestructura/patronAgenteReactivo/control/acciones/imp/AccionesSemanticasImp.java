...
import icaro.infraestructura.patronAgenteReactivo.control.factoriaEInterfaces.imp.ProcesadorInfoReactivoImp;
...
import java.util.logging.Logger;
         ...
         *  ejecutarn dinmicamente por el autmata
         *
         *	@author		Jorge Gonzlez, David lvarez Martnez
...
public class AccionesSemanticasImp extends AccionesSemanticasAbstracto {
    ...
    protected ProcesadorInfoReactivoImp controlAgteReactivo;
    ...
    public void setControlAgteReactivo (ProcesadorInfoReactivoImp contrAgteReactivo){
        controlAgteReactivo = contrAgteReactivo;
    }

     public ProcesadorInfoReactivoImp  getControlAgteReactivo (){
        return controlAgteReactivo ;
    }
    /**
