...
public class VisorEscenariosRosace2 extends JFrame {
    ...
    private String imageniconoRobot = "Robot.png";
     private static  Image IMAGErobot,IMAGEmujer ;
...
//                   VisorEscenariosRosace2 visor = new VisorEscenariosRosace2(rutaFichero);
//                    JFrame frame = new JFrame("Demo 2");
//                frame.setMinimumSize(new Dimension(500, 400));
//                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    VisorEscenariosRosace2 visor = new VisorEscenariosRosace2();
                   visor.getContentPane().setVisible(true);
...
//                    visor.escribirEnAreaTexto("La Victim.7 ha sido rescatada\n");
     ...
     * Create the frame.
     */
    public VisorEscenariosRosace2(String rutaFicheroRobotsTest) throws Exception {
        
    }
    public VisorEscenariosRosace2() throws Exception {
...
//        ReadXMLTestRobots rXMLTRobots = new ReadXMLTestRobots(rutaFicheroRobotsTest);
        ...
        IMAGEmujer = Utilities.loadImage ( rutapaqueteConstructorEscenariosROSACE +imageniconoMujerRescatada); 
        ...
        scrollPane.setName(tituloVentanaVisor);
...
//            victimWid.setPreferredLocation(new Point(coordinateX,coordinateY));
            scene.addNode("victima"+idNumero).setPreferredLocation(new Point(coordinateX,coordinateY)) ;
            panelVisor.add(label);
