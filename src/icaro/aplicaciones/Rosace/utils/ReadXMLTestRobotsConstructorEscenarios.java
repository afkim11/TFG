...
public class ReadXMLTestRobotsConstructorEscenarios {

	private String sequenceTestPath;
	
	public ReadXMLTestRobotsConstructorEscenarios(String testFilePath){
	...
	public NodeList getRobotsXMLStructure(Document doc, String tag){
    ...
    public Element getRobotElement(NodeList nodeLst, int sequencePosition){
    	  Element info=null;
    ...
    public String getRobotIDValue(Element info, String tag){
    ...
    public int getRobotInitialEnergy(Element info, String tag){
    ...
    private String getRobotCoordinateX(Element info, String tagcoordinate, String tagdimension){
          String valuex = "";          
    ...
    private String getRobotCoordinateY(Element info, String tagcoordinate, String tagdimension){
          String valuey = "";        
		  NodeList coordinateNmElmntLst = info.getElementsByTagName(tagcoordinate);
		  Node coordinateNode = coordinateNmElmntLst.item(0);
		  if (coordinateNode.getNodeType() == Node.ELEMENT_NODE){
    ...
    public Coordinate getRobotCoordinate(Element info){
    ...
    public float getRobotHealRange(Element info, String tag){
...
//    public Coordinate getRobotCoordinate(String robotName){
//    	Coordinate c=null;
