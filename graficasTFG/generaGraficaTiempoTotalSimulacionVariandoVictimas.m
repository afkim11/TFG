...
for i=1:length(escenariosCasa)
  if escenariosCasa{i}{3} == 1
    if escenariosCasa{i}{2} == nvictims1
      p14 = [p14 max(escenariosCasa{i}{5}(:,3))];
    elseif escenariosCasa{i}{2} == nvictims2
      p16 = [p16 max(escenariosCasa{i}{5}(:,3))];
    elseif escenariosCasa{i}{2} == nvictims3
      p18 = [p18 max(escenariosCasa{i}{5}(:,3))];
    endif
  elseif escenariosCasa{i}{3} == 2
    if escenariosCasa{i}{2} == nvictims1
      p24 = [p24 max(escenariosCasa{i}{5}(:,3))];
    elseif escenariosCasa{i}{2} == nvictims2
      p26 = [p26 max(escenariosCasa{i}{5}(:,3))];
    elseif escenariosCasa{i}{2} == nvictims3
      p28 = [p28 max(escenariosCasa{i}{5}(:,3))];
    endif
  elseif escenariosCasa{i}{3} == 3
   if escenariosCasa{i}{2} == nvictims1
      p34 = [p34 max(escenariosCasa{i}{5}(:,3))];
    elseif escenariosCasa{i}{2} == nvictims2
      p36 = [p36 max(escenariosCasa{i}{5}(:,3))];
    elseif escenariosCasa{i}{2} == nvictims3
      p38 = [p38 max(escenariosCasa{i}{5}(:,3))];
    endif
  endif
endfor
